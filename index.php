    ...
    <?php include "homeheader.php"; ?>
        ...
        <div class="bodycontainer">
        	...
        	<a href="./cat-audio.php">
				<div class="gridentry boxsize">
					<i id="audioicon" class="icon-volume-up"></i>
					<!-- <img src="./images/image-audio.png" width="100%"> -->
					<!-- <div class="gridentrymask"></div> -->
					<div class="gridentrytext boxsize">Audio</div>
				</div>
			</a>

			<a href="./cat-webdev.php">
				<div class="gridentry boxsize">
					<i id="webicon" class="icon-globe"></i>
			...
			<a href="./cat-gamedev.php">
				<div class="gridentry boxsize">
					<i id="gameicon" class="icon-gamepad"></i>
			...
			<a href="./cat-physics.php">
				<div class="gridentry boxsize">
					<i id="physicsicon" class="icon-magnet"></i>
			...
			<a href="./cat-music.php">
				<div class="gridentry boxsize">
					<i id="musicicon" class="icon-music"></i>
			...
			<a href="./cat-about.php">
				<div class="gridentry boxsize">
					<i id="abouticon" class="icon-male"></i>
